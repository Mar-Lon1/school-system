...
class RegistrationFeeController extends Controller
{
    ...
    public function RegFeeClassData(Request $request){
        ...
        foreach ($allStudent as $key => $v) {
            ...
            $html[$key]['tdsource'] .='<a class="btn btn-sm btn-'.$color.'" title="FeeSlip" target="_blanks" href="'.route("student.registration.fee.payslip").'?class_id='.$v->class_id.'&student_id='.$v->student_id.'">Fee Slip</a>';
            $html[$key]['tdsource'] .= '</td>';
   ...
   public function RegFeePayslip (Request $request) {
    ...
    $allStudent['details'] = AssignStudent::with(['student', 'discount'])->where('student_id', $student_id)->where(
        ...
        return $pdf->download('registration_fee.pdf');
