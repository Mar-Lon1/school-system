...
<table id="customers">
  <tr>
   <td><h2>
  <?php $image_path = '/upload/tinkabella_logo.jpeg'; ?>
  <img src="{{ public_path() . $image_path }}" width="200" height="200">

    </h2></td>
    <td><h2>Tinkabella Complex School ERP</h2>
<p>School Address:</p>
<p>Phone : 233264661364</p>
<p>Email : info@tinkabella.edu.gh</p>
...
<table id="customers">
  ...
  <tr>
    ...
    <tr>
    <td>9</td>
    <td><b>Fee For This Student in {{ $month }}</b></td>
    <td>GHS{{ $finalfee }}.00</td>
  </tr>
